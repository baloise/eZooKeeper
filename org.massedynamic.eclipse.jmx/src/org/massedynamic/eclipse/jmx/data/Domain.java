...
public final class Domain implements IObjectNamePart {
     ...
     * (non-Javadoc)
     * 
     * @see org.massedynamic.eclipse.zookeeper.data.jmx.copy.ObjectNamePart#getChildObjectNameKeyValues()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.massedynamic.eclipse.zookeeper.data.jmx.copy.ObjectNamePart#getObjectNamePartString()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.massedynamic.eclipse.zookeeper.data.jmx.copy.ObjectNamePart#getParentObjectNamePart()
     */
    @Override
