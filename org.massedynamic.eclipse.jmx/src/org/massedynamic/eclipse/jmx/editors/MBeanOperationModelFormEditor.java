 ...
 * @author Mark Masse
 */
public class MBeanOperationModelFormEditor extends MBeanFeatureModelFormEditor<MBeanOperationModel> {

    public static final String ID = MBeanOperationModelFormEditor.class.getName();
