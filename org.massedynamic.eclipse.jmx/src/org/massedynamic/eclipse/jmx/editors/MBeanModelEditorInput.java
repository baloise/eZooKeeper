 ...
 * @author Mark Masse
 */
public class MBeanModelEditorInput extends DataModelEditorInput<MBeanModel> {

    public MBeanModelEditorInput(String editorId, MBeanModel model) {
        super(editorId, model, new MBeanModelElementType());
    }
