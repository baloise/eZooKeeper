...
import org.massedynamic.eclipse.core.model.OperationNotSupportedException;
import org.massedynamic.eclipse.jmx.data.Domain;
import org.massedynamic.eclipse.jmx.data.ObjectNameKeyValue;
import org.massedynamic.eclipse.jmx.data.IObjectNamePart;
...
public abstract class AbstractObjectNameKeyValueModelSource<M extends AbstractObjectNameKeyValueModel<M, K, D>, K extends Comparable<K>, D>
     ...
     * (non-Javadoc)
     * 
     * @see org.massedynamic.eclipse.zookeeper.model.DataModelSource#findKeys(java.lang.Object)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.massedynamic.eclipse.zookeeper.model.AbstractDataModelSource#isFindKeysSupported(java.lang.Object)
     */
    @Override
