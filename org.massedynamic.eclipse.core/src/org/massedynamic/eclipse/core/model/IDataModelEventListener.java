...
/**
 * Typed data model listener interface.
 * 
 * @author Mark Masse
 */
public interface IDataModelEventListener<M extends DataModel<M, ?, ?>> extends EventListener {
     ...
     */
    public void dataModelDestroyed(DataModelEvent<M> event);
     ...
     * @param event The data model event.
     */
    public void dataModelDataChanged(DataModelEvent<M> event);
     ...
     */
    public void dataModelDataRefreshed(DataModelEvent<M> event);
}
