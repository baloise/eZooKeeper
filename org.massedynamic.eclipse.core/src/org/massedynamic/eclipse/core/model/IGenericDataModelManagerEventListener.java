...
/**
 * Untyped data model manager listener interface.
 * 
 * @see DataModel
 * @see DataModelManager#addGenericEventListener(IGenericDataModelManagerEventListener)
 * 
 * @author Mark Masse
 */
public interface IGenericDataModelManagerEventListener extends EventListener {
